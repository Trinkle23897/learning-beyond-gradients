...
def _generation_4_development_lines(ledger_path: Path) -> list[str]:
    ...
    parallel_g4_parallel9_attack_scalar_note = results_dir.parent / "notes" / "parallel" / "20260527_g4_parallel9_attack_scalar.md"
    parallel_g4_parallel9_grounded_note = results_dir.parent / "notes" / "parallel" / "20260527_g4_parallel9_grounded_low_receive.md"
    parallel_g4_parallel9_trace_report = reports_dir / "parallel" / "20260527_g4_parallel9_trace_attack_rnn.md"
    parallel_g4_parallel9_rear_wall_note = results_dir.parent / "notes" / "parallel" / "20260527_g4_parallel9_rear_wall_press.md"
    parallel_g4_parallel9_archived_robustness_note = results_dir.parent / "notes" / "parallel" / "20260527_g4_parallel9_archived_robustness.md"
    parallel_g4_parallel9_synthesis_report = reports_dir / "parallel" / "20260527_g4_parallel9_synthesis.md"
    ...
    lines = [
        ...
        f"- Generation-4 parallel9 attack scalar/config note: `{parallel_g4_parallel9_attack_scalar_note}`",
        f"- Generation-4 parallel9 grounded-low-receive note: `{parallel_g4_parallel9_grounded_note}`",
        f"- Generation-4 parallel9 attack/baseline-rnn trace report: `{parallel_g4_parallel9_trace_report}`",
        f"- Generation-4 parallel9 rear-wall press note: `{parallel_g4_parallel9_rear_wall_note}`",
        f"- Generation-4 parallel9 archived-opponent robustness note: `{parallel_g4_parallel9_archived_robustness_note}`",
        f"- Generation-4 parallel9 synthesis report: `{parallel_g4_parallel9_synthesis_report}`",
