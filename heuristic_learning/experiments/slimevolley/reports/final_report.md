...
| `results/generation_5_phase_pressure_selective_probe.json` | JSON results for the development-only selective phase-pressure follow-up; records narrowed descending/depth screens and rejected full-pool `phase_two_frame_descending` and `phase_two_frame_back_desc`. | `.venv/bin/python experiments/slimevolley/probes/g5_phase_pressure_probe.py --phase screen/full --candidate ... --output experiments/slimevolley/results/generation_5_phase_pressure_selective_probe.json` | reviewer inspection; development-seed evidence only, no holdout/audit opened |
...
| `notes/parallel/20260527_g4_parallel9_attack_scalar.md` | Development-only parallel9 attack scalar/config search; records `rank1_builtin_combo` improving `attack_reference` but still below `baseline-rnn`, with no promotion. | no-ledger generation-4 dev diagnostics | reviewer inspection; development-seed evidence only |
| `results/generation_4_parallel9_attack_scalar_probe.json` | JSON rows for the development-only parallel9 attack scalar/config screen and full built-in validation. | transient `/tmp/g4_parallel9_attack_scalar_probe.py` | reviewer inspection; development-seed evidence only, no holdout/audit opened |
| `notes/parallel/20260527_g4_parallel9_grounded_low_receive.md` | Development-only parallel9 grounded-low-receive probe; records narrow low-net and split front/rear branches that tied the reference and were rejected. | no-ledger generation-4 dev diagnostics | reviewer inspection; development-seed evidence only |
| `results/generation_4_parallel9_grounded_low_receive_probe.json` | JSON rows for the development-only parallel9 grounded-low-receive short screen on `9000..9015`. | transient `/tmp/g4_parallel9_grounded_low_receive_probe.py --phase screen` | reviewer inspection; development-seed evidence only, no holdout/audit opened |
| `reports/parallel/20260527_g4_parallel9_trace_attack_rnn.md` | Development-only parallel9 trace diagnostic comparing `attack` and `baseline-rnn` on generation-4 dev seeds. | no-ledger generation-4 trace diagnostics | reviewer inspection; development-seed evidence only |
| `results/generation_4_parallel9_trace_attack_rnn.json` | Machine-readable trace rows for the parallel9 `attack` versus `baseline-rnn` diagnostic. | no-ledger trace diagnostic | reviewer inspection; development-seed evidence only |
| `notes/parallel/20260527_g4_parallel9_rear_wall_press.md` | Development-only parallel9 rear-wall press/low-jump probe; records local branch substitutions that tied hard rows or regressed built-in. | no-ledger generation-4 dev diagnostics | reviewer inspection; development-seed evidence only |
| `results/generation_4_parallel9_rear_wall_press_probe.json` | JSON rows for the development-only parallel9 rear-wall screen, full built-in check, and fixed-pool diagnostics. | transient `/tmp/g4_parallel9_rear_wall_press_probe.py` | reviewer inspection; development-seed evidence only, no holdout/audit opened |
| `notes/parallel/20260527_g4_parallel9_archived_robustness.md` | Development-only parallel9 archived-opponent robustness note for current generation-4 references; records no promotion. | existing generation-4 dev artifacts and summary rows | reviewer inspection; development-seed evidence only |
| `results/generation_4_parallel9_archived_robustness.json` | Machine-readable fixed-pool robustness summary for the parallel9 archived-opponent check. | synthesized from existing generation-4 dev artifacts | reviewer inspection; development-seed evidence only |
| `reports/parallel/20260527_g4_parallel9_synthesis.md` | Development-only parallel9 synthesis across attack scalar, grounded-low-receive, rear-wall, trace, and robustness workers; records no maintained edit. | maintained after 2026-05-27 parallel9 worker completion | reviewer inspection; development-seed evidence only |
...
- Generation-4 parallel7 attack scalar/config note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel7_attack_scalar.md`
- Generation-4 parallel7 grounded-low-receive note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel7_grounded_low_receive.md`
- Generation-4 parallel7 attack/rally-serve/post-contact/RNN trace report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel7_trace_attack_rnn.md`
- Generation-4 parallel7 rear-wall press note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel7_rear_wall_press.md`
- Generation-4 parallel7 archived-opponent robustness note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel7_archived_robustness.md`
- Generation-4 parallel7 synthesis report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel7_synthesis.md`
- Generation-4 parallel8 attack scalar/config note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel8_attack_scalar.md`
- Generation-4 parallel8 grounded-low-receive note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel8_grounded_low_receive.md`
- Generation-4 parallel8 grounded-low-receive result: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/results/generation_4_parallel8_grounded_low_receive_probe.json`
- Generation-4 parallel8 attack/baseline-rnn trace report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel8_trace_attack_rnn.md`
- Generation-4 parallel8 rear-wall press note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel8_rear_wall_press.md`
- Generation-4 parallel8 rear-wall press result: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/results/generation_4_parallel8_rear_wall_press_probe.json`
- Generation-4 parallel8 archived-opponent robustness note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel8_archived_robustness.md`
- Generation-4 parallel8 synthesis report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel8_synthesis.md`
- Generation-4 parallel9 attack scalar/config note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel9_attack_scalar.md`
- Generation-4 parallel9 grounded-low-receive note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel9_grounded_low_receive.md`
- Generation-4 parallel9 attack/baseline-rnn trace report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel9_trace_attack_rnn.md`
- Generation-4 parallel9 rear-wall press note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel9_rear_wall_press.md`
- Generation-4 parallel9 archived-opponent robustness note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/parallel/20260527_g4_parallel9_archived_robustness.md`
- Generation-4 parallel9 synthesis report: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/reports/parallel/20260527_g4_parallel9_synthesis.md`
...
- Generation-5 rollout-search probe note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/generation_5_rollout_search_probe.md`
- Generation-5 rollout-mined rule probe note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/generation_5_rollout_mined_rule_probe.md`
- Generation-5 stacked-mined rule probe note: `/home/alpha/dev/research/learning-beyond-gradients/heuristic_learning/experiments/slimevolley/notes/generation_5_stacked_mined_rule_probe.md`
...
- Additional generation-5 mixed direction: phase-gated opponent-side low pressure improved some hard archived rows, with `phase_two_frame` moving built-in by `+0.04` and `improved-v5/v6` by `+0.10/+0.12`; selective `phase_two_frame_descending` improved built-in by `+0.04` and the hard tail but regressed `improved-v2` by `-0.10`; the later `phase_two_frame_back_desc` preserved `improved-v2/v3` and improved `improved-v4/v5/v6` by `+0.06/+0.08/+0.08`, but regressed built-in by `-0.02` and still stayed far below `baseline-rnn`, so no maintained policy edit was promoted.
