...
PHASE_CONFIGS: dict[str, PhasePressureConfig] = {
    ...
    "phase_two_frame_back_desc": PhasePressureConfig(
        name="phase_two_frame_back_desc",
        label="structural/history: two-frame descending pressure only when opponent is deeper",
        ball_y_max=0.58,
        ball_vy_max=-0.05,
        opponent_y_max=0.24,
        opponent_x_min=0.76,
    ...
    "phase_two_frame_back_low_desc": PhasePressureConfig(
        name="phase_two_frame_back_low_desc",
        label="structural/history: lower descending two-frame pressure only when opponent is deeper",
        ball_y_max=0.50,
        ball_vy_max=-0.05,
        opponent_y_max=0.22,
        opponent_x_min=0.76,
